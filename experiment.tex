...
The data used in this dissertation were collected from proton-proton collisions in the Large Hadron Collider (LHC), a circular particle-beam collider built by the European Organization for Nuclear Research (CERN). The products of these collisions were recorded by a particle detector called the Compact Muon Solenoid (CMS). This chapter presents a brief overview of the LHC, followed by a description of the CMS detector, its component subsystems, and its data acquisition system.
